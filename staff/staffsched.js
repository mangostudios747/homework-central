export let sched = {
    ...
    "egaribaydiaz@pausd.org": {
        "lastName": "Garibay Diaz",
        "semesters": {
            "S1": {
                "SELF": "SELF"
            },
    ...
    "tkaneko@pausd.org": {
        ...
        "semesters": {
            "S1": {
                ...
                "2": "Funct Object Or Prog",
                "3": "Funct Object Or Prog",
                "6": "IntrAnl/Calc",
                "7": "IntrAnl/Calc",
                "SELF": "SELF"
            },
    ...
    "mhernandez@pausd.org": {
        ...
        "semesters": {
            "S1": {
                ...
                "3": "Film Lit",
                "4": "Am Clas11H",
                "5": "AP English Lit & Comp",
                "6": "AP English Lit & Comp",
                "SELF": "SELF"
            },
            "S2": {
                "1": "Film Lit",
    ...
    "cpeters@pausd.org": {
        ...
        "semesters": {
            "S1": {
                "2": "Fiber Arts",
                "3": "Ind Study",
                "4": "Culinary Arts - Introduction",
                "5": "Culinary Arts - Introduction",
                "6": "Ind Study",
                "SELF": "SELF"
            },
            "S2": {
                "2": "Interior11",
                "3": "SportsNutr",
                "4": "Culinary Arts - International",
                "5": "Culinary Arts - International",
                "6": "Ind Study",
                "SELF": "SELF"
            }
        }
    ...
    "rcuevasceja@pausd.org": {
        "lastName": "Cuevas Ceja",
        "semesters": {
            "S1": {
                "1": "Voc Trng",
                "4": "Voc Trng",
    ...
    "dmessinger@pausd.org": {
        "lastName": "Messinger",
        "semesters": {
            "S1": {
                "1": "Pt/Dr 1",
                "3": "Adv.Draw/Painting H",
                "4": "AP Studio Art - Drawing"
            },
            "S2": {
                "1": "Pt/Dr 1",
                "3": "Adv.Draw/Painting H",
    ...
    "mgleason@pausd.org": {
        ...
        "semesters": {
            "S1": {
                ...
                "4": "Adv Gr Des",
                "5": "Gprd/Yrbk",
                "6": "Digital Art Spectrum",
                "7": "Digital Art Spectrum"
            },
            "S2": {
                "3": "GraphDes",
                "4": "Adv Gr Des",
    ...
    "jpaley@pausd.org": {
        ...
        "semesters": {
            "S1": {
                "3": "APCompSci A",
                "4": "APCompSci A",
                "5": "Funct Object Or Prog",
                "6": "Funct Object Or Prog",
                "7": "CS Capstone"
            },
            "S2": {
                "3": "APCompSci A",
